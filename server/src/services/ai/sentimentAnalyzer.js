const KEYWORD_MAP = {
  stress: ['overwhelmed', 'tired', 'stressed', 'busy', 'exhausted', 'pressure', 'deadline', 'burnout', 'overworked'],
  happy: ['happy', 'great', 'wonderful', 'amazing', 'grateful', 'joy', 'blessed', 'fantastic', 'beautiful', 'delighted', 'thrilled'],
  lonely: ['alone', 'lonely', 'miss', 'isolated', 'distant', 'disconnected', 'solitary', 'abandoned', 'forgotten'],
  anxious: ['anxious', 'worried', 'nervous', 'scared', 'panic', 'fear', 'uneasy', 'restless', 'tense', 'terrified', 'overthinking'],
  ...
  grateful: ['grateful', 'thankful', 'blessed', 'appreciate', 'fortunate', 'gratitude', 'lucky', 'blessing'],
};
...
export function findDominantCategory(keywords, moodId) {
  if (keywords.length === 0) {
    const moodCategoryMap = {
      happy: 'happy', calm: 'calm', neutral: 'default',
      sad: 'sad', angry: 'stress', anxious: 'anxious', excited: 'happy',
    };
